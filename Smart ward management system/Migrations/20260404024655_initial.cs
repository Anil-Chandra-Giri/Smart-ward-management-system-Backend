        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EscalationHistories_Assignment_AssignmentId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("5bd806cd-16d3-4eb8-a1d8-191310e969ab"), null, "jane@example.com", true, "DL-002", "Jane Smith", "0987654321" },
                    { new Guid("9b052dc0-8b94-49a1-90fd-eed680b6dd05"), null, "john@example.com", true, "DL-001", "John Doe", "1234567890" }
                });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "UserId", "AccountStatus", "CitizenshipIssuedDate", "CitizenshipIssuedDistrict", "CitizenshipNumber", "CreatedAt", "DateOfBirth", "Department", "Designation", "District", "Email", "EmployeeId", "FullNameEnglish", "FullNameNepali", "Gender", "IsEmailConfirmed", "IsVerified", "LastOtpRequestTime", "Municipality", "NationalIdNumber", "OtpAttempts", "OtpCode", "OtpExpiryTime", "PasswordHash", "PermanentAddress", "PhoneNumber", "ProfilePicturePath", "Province", "Role", "TemporaryAddress", "UpdatedAt", "Username", "VerificationStatus", "VerifiedAt", "VerifiedBy", "WardNumber" },
                values: new object[] { new Guid("11111111-1111-1111-1111-111111111111"), "Active", new DateTime(2010, 5, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), "Kathmandu", "123456789", new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(1990, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, null, "Kathmandu", "admin@ward.gov.np", null, "System Admin", "प्रशासक", "Male", true, true, null, "Kathmandu Metropolitan", null, 0, null, null, "AQAAAAIAAYagAAAAEAB9zLigadl2431aHLhlcKzzUiGBjUWRmnwFIDF3CT94M3BkfYp/3J7pS66wz7oj2w==", "Kathmandu", "9800000000", "", "Bagmati", "Staff", "Kathmandu", new DateTime(2026, 4, 4, 2, 46, 52, 138, DateTimeKind.Utc).AddTicks(441), "admin", 2, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new Guid("11111111-1111-1111-1111-111111111111"), "1" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("919f656d-137e-48af-b07d-074d10b288a0"), 3.0, 0.0, true, null, new DateTime(2026, 4, 4, 8, 31, 52, 139, DateTimeKind.Local).AddTicks(8075), 0.0, 0.0, null, 1, "Truck 2", "VH-002", "Dumper" },
                    { new Guid("d29ef8a6-2d67-46ac-994c-9d40e8fa21ed"), 5.0, 0.0, true, null, new DateTime(2026, 4, 4, 8, 31, 52, 139, DateTimeKind.Local).AddTicks(8053), 0.0, 0.0, null, 1, "Truck 1", "VH-001", "Compactor" }
                });
