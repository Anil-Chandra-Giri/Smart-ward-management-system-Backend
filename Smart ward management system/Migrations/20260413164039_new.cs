    ...
    public partial class @new : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("52c26ebd-83a8-4469-a0c6-ed1f4fd2ea8e"), null, "john@example.com", true, "DL-001", "John Doe", "1234567890" },
                    { new Guid("9cacd029-794d-44dd-8636-f935397c6c62"), null, "jane@example.com", true, "DL-002", "Jane Smith", "0987654321" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("29dc8345-daec-4e79-b94c-faec7ca3db00"), 3.0, 0.0, true, null, new DateTime(2026, 4, 13, 22, 25, 39, 92, DateTimeKind.Local).AddTicks(6869), 0.0, 0.0, null, 1, "Truck 2", "VH-002", "Dumper" },
                    { new Guid("5163e90d-fb3f-4863-8d13-62e3bd88abd5"), 5.0, 0.0, true, null, new DateTime(2026, 4, 13, 22, 25, 39, 92, DateTimeKind.Local).AddTicks(6857), 0.0, 0.0, null, 1, "Truck 1", "VH-001", "Compactor" }
                });
