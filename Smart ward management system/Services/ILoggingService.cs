...
namespace Smart_ward_management_system.Services
{
    public interface ILoggingService
    {
        ...
        // Use this (instead of LogInfoAsync) for any create/update/delete that
        // should be reversible later. targetEntityType is a short key like
        // "Staff" that IEntityRestoreHandler implementations register under.
        // before = null for a Create action. after = null for a Delete action.
